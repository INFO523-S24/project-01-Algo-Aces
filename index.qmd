...
Limitations: 1) The reason to choose median over mean to calculate average calories is because the provided data from the dataset is skewed and there is an asymmetrical distribution of the data for the variables. The data also contains outliers which can affect the mean value but not the median. 2) The definition of what the health metric should be based on the dataset provided was made difficult. A special health metric was generated based on our analysis for this project.
