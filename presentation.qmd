...
![Scatter Plot depicting the Protein-Fat ratio for each outlet.](images/output4q2(corrected).png){width="650"}
...
-   Plot B (Scatter plot) extends the analysis on the results of plot A by showing the median values and categorizing them into - RED & GREEN regions.
